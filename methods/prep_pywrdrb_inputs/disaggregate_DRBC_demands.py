...
from config import DATA_DIR, PYWRDRB_INPUT_DIR
spatial_data_dir = DATA_DIR + "/DRB_spatial"


from pywrdrb_node_data import upstream_nodes_dict
...
def disaggregate_DRBC_demands(input_dir=PYWRDRB_INPUT_DIR):
    """
