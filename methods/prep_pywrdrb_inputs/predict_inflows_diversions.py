...
from config import PYWRDRB_INPUT_DIR, FIG_DIR
...
def predict_inflows_diversions(
    ...
    start_date,
    end_date,
    regression_modes=["regression_disagg"],  # opts: "perfect_foresight", "same_day", "regression_disagg"
    use_log=True,
    remove_zeros=False,
    use_const=False,
    realization=None,
    ...
    catchment_inflows = catchment_inflows.replace(0, 0.001)
    
    # replace nan with 0.001
    catchment_inflows = catchment_inflows.fillna(0.001)
